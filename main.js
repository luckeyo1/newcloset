    ...
    connectedCallback() {
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .card {
                    background-color: oklch(35% 0.05 240);
                    border-radius: 12px;
                    box-shadow: 0 8px 25px oklch(20% 0.05 240 / 40%);
                    overflow: hidden;
                ...
                .card:hover {
                    ...
                    box-shadow: 0 12px 35px oklch(20% 0.05 240 / 60%);
                }
                .card-image {
                    width: 100%;
                ...
                .card-category {
                    ...
                    background-color: oklch(25% 0.05 240 / 80%);
